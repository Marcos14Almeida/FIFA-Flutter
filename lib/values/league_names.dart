  ...
  List getAllLeagueNames(){
    return [
     ...
     holanda, portugal, turquia,
      ...
      cazaquistao, chipre, croacia, dinamarca,
      escocia, eslovaquia, eslovenia, estonia,
      letonia, lituania,
      finlandia, georgia, gibraltar, grecia, hungria,
...
Map getLeagueNationalityMap(){
  ...
  return {
    ...
    leagueName.moldova: Words.country.moldova,
    ...
    leagueName.libia: Words.country.libya,
    ...
    leagueName.rs: Words.country.rs,
    leagueName.parana: Words.country.pr,
    leagueName.sc: Words.country.sc,
